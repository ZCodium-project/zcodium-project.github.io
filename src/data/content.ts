...
export const copy: Record<Lang, Copy> = {
  zh: {
    ...
    hero: {
      ...
      osSuffix: " 版",
      installHint: "未签名的 .dmg：拖入“应用程序”后，用 sudo /usr/bin/xattr -rd com.apple.quarantine 放行一次（输入密码时不显示字符）",
  ...
  en: {
    ...
    hero: {
      ...
      osSuffix: "",
      installHint: "Unsigned .dmg: after dragging it into Applications, run sudo /usr/bin/xattr -rd com.apple.quarantine once (nothing is shown while typing the password)",
