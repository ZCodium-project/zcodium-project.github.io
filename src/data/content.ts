...
export const copy: Record<Lang, Copy> = {
  zh: {
    ...
    hero: {
      ...
      osSuffix: " 版",
      installHint: "没有官方签名：拖入“应用程序”后，用 sudo /usr/bin/xattr -rd com.apple.quarantine 放行一次（输入密码时不显示字符）",
  ...
  en: {
    ...
    hero: {
      ...
      osSuffix: "",
      installHint: "No official signature: after dragging it into Applications, run sudo /usr/bin/xattr -rd com.apple.quarantine once (nothing is shown while typing the password)",
